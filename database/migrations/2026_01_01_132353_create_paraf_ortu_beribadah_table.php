...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('paraf_ortu_beribadah')) {
            Schema::create('paraf_ortu_beribadah', function (Blueprint $table) {
                $table->id();
                
                // Foreign Keys - Relasi ke tabel beribadahs
                ...
                $table->foreignId('ortu_id')
                      ...
                      ->onDelete('set null')
                      ->comment('ID orangtua yang memberikan paraf');
            ...
            \Illuminate\Support\Facades\DB::statement('
                ALTER TABLE paraf_ortu_beribadah 
                ADD CONSTRAINT chk_jenis_sholat 
                CHECK (jenis_sholat IN ("subuh", "dzuhur", "ashar", "maghrib", "isya", "semua"))
            ');
        }
    }
