...
<head>
    ...
    <title>Tambah Siswa - 7 Kebiasaan Anak Indonesia Hebat</title>
    <style>
        @keyframes fadeIn {
        ...
        <div class="glass-card rounded-2xl shadow-lg overflow-hidden fade-in" style="animation-delay: 0.1s;">
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h2 class="text-lg font-semibold text-gray-900">Form Data Siswa</h2>
                        <p class="text-gray-500 text-sm">Semua field wajib diisi</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('siswas.store') }}" method="POST" class="p-6 md:p-8">
                @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <option value="L" {{ old('jenis_kelamin') == 'L' ? 'selected' : 'selected' }}>Laki-laki</option>
