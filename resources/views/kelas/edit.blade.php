...
<head>
    ...
    <title>Edit Kelas - 7 Kebiasaan Anak Indonesia Hebat</title>
    <style>
        @keyframes fadeIn {
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm mt-1">
                            Ubah data kelas {{ $kelas->nama_kelas }}
                        </p>
                    </div>
                </div>
                <!-- Badge -->
            ...
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Perbarui data kelas sesuai kebutuhan</p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    @foreach($guruWali as $guru)
                                        <option value="{{ $guru->id }}" {{ old('guru_wali_id', $kelas->guru_wali_id) == $guru->id ? 'selected' : '' }}>
                                            {{ $guru->nama_lengkap }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                >
                                    ...
                                    <option value="2023/2024" {{ old('tahun_ajaran', $kelas->tahun_ajaran) == '2023/2024' ? 'selected' : '' }}>2023/2024</option>
