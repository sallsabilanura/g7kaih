...
<head>
    ...
    <title>Edit Pengaturan Waktu - 7 Kebiasaan Anak Indonesia Hebat</title>
    <style>
        @keyframes fadeIn {
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold bg-gradient-to-r from-primary-600 to-accent-green bg-clip-text text-transparent">
                            Edit Pengaturan Waktu
                        </h1>
                        <p class="text-gray-500 text-sm mt-1">
                            Edit data pengaturan waktu bangun pagi
                        </p>
                    </div>
                </div>
            ...
            <div class="px-8 py-6 border-b border-gray-100">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Perbarui informasi pengaturan waktu</p>
                    </div>
                </div>
            </div>

            <form action="{{ route('pengaturan-waktu-bangun-pagi.update', $pengaturan->id) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    value="{{ old('waktu_100_start', $pengaturan->waktu_100_start) }}"
                                >
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    required 
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:border-primary-500 transition-all duration-300 text-gray-900 bg-white shadow-sm"
                                    value="{{ old('waktu_100_end', $pengaturan->waktu_100_end) }}"
                                >
                                @error('waktu_100_end')
                                    <p class="text-red-500 text-sm mt-2 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    required 
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:border-primary-500 transition-all duration-300 text-gray-900 bg-white shadow-sm"
                                    value="{{ old('nilai_100', $pengaturan->nilai_100) }}"
                                >
                                @error('nilai_100')
                                    <p class="text-red-500 text-sm mt-2 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    required 
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:border-primary-500 transition-all duration-300 text-gray-900 bg-white shadow-sm"
                                    value="{{ old('waktu_70_start', $pengaturan->waktu_70_start) }}"
                                >
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    required 
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:border-primary-500 transition-all duration-300 text-gray-900 bg-white shadow-sm"
                                    value="{{ old('waktu_70_end', $pengaturan->waktu_70_end) }}"
                                >
                                @error('waktu_70_end')
                                    <p class="text-red-500 text-sm mt-2 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    required 
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:border-primary-500 transition-all duration-300 text-gray-900 bg-white shadow-sm"
                                    value="{{ old('nilai_70', $pengaturan->nilai_70) }}"
                                >
                                @error('nilai_70')
                                    <p class="text-red-500 text-sm mt-2 flex items-center">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
